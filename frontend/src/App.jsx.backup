              ...
              >
                <div className="urgency-header">
                  <div className="urgency-icon">
                    {caseRedFlagResult.has_red_flags ? "⚠️" : "✓"}
                  </div>
